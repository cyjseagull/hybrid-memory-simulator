...
#ifdef NVMAIN
  section("nvmain configuration");
  add( nvmain_config_path , "nvmain_config_path","path of nvmain config file");
#endif
...
#ifdef NVMAIN
//log nvmain
	std::cout<<"ptlsim: log nvmain"<<std::endl;	
	machine->nvm_simulation_done();
#endif

#if ((defined DRAMSIM) || (defined HYBRIDSIM))
	std::cout<<"ptlsim: log dramsim2"<<std::endl;
